...
pckgs <- c("nycflights13", "mosaic",  "broom", "corrr", "lubridate", "viridis", 
           "GGally", "ggmap", "pacman", "sjmisc", "leaflet", "knitr",  "tidyverse", "tidyimpute", "na.tools")
...
Use `search()` to see loaded packages and `installed.packages()` for installed pacakges. 
...
```{r echo = FALSE, fig.asp = .8, out.width="60%"}
mtcars %>% 
  select_if(is.numeric) %>% 
