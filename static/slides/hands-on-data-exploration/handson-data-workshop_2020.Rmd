...
```{r define-checkpoint, echo = TRUE, eval = FALSE}
library(checkpoint)
checkpoint("2020-10-14", r_version="4.0.2")
```


```{r name-pckgs, echo = FALSE}
...
```{r install-nycflights, eval = FALSE}
...
```{r power, echo = FALSE, out.width="50%"}
...
```{r love-old-way, out.width = "50%", echo = FALSE}
...
```{r nice-data, out.width="50%", echo = FALSE}
...
```{r praxisprobleme, echo = FALSE, out.width="100%"}
...
```{r moderndive, out.width = "70%", echo = FALSE}
...
```{r modar, out.width="30%", echo = FALSE}
...
```{r cheatsheet, echo =FALSE, out.width="50%"}
...
```{r overhead-bin, echo = FALSE, out.width="50%"}
