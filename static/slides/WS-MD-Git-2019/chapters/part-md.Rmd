...
# Ein Credo zum Textschreiben: Ich glaube, dass man beim Schreiben ...


1. nur schreiben soll, sich nicht schon mit der Formatierung beschäftigen soll.

2. immer nur eine Sache zu einer Zeit tun soll. Man beginne mit der Gliederung, es folgen stichpunktartige Notizen dazu, schließlich formuliere man die Sätze aus, danach erst beginne man mit der Formatierung.

3. reichlich von Metatext Gebrauch machen soll, in Sinne von Kommentaren über seinen Text, die man in den Text einfügt als Gedankenstütze.

4. zum Schluss auf anspruchsvolle Typografie achten soll. Der Textsatz soll ästethisch ansprechen und gut lesbar sein. Allerdings verzichte man auf Schnörkel und aufwändige Formatierung von Hand. Die Zeit ist besser in den Inhalt gesteckt.
