...
- *Working Tree*: Dateisystem der Repos in aktueller (oder früherer) Version
...
`r icon::fa("exclamation")` Man kann jetzt keine Änderungen vornehmen (*detached head*), sondern nur alte Zustände betrachten^1^.
