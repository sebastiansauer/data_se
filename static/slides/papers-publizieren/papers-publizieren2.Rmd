...
date: "CC-BY-4.0; https://data-se.netlify.com/slides/papers-publizieren/papers-publizieren2.html#1"
...
nimm meine_rohdaten und dann ...
  ...
  berechne(umsatz_mw = mittel(umsatz_produkte)) speichere als meine_daten
```
