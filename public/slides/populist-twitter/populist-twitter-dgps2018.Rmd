...
# AfD and Linke: highest overall populism score

(But Trump's populism score is the greatest; great genes)
...
# AfD and the Union parties use relative words such as "deutsch*" 
...
#### `r icon:fa("code")` Get code and data here: 
