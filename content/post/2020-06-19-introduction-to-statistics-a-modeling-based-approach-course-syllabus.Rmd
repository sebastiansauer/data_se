...
Suggested literature for deepening the analytic skills include [Statistical Rethinking](https://xcelab.net/rm/statistical-rethinking/). While I wholeheartedly recommend such books, we will not be able to discuss many of the ideas presented therein in class (in this course) due to time constraints.
