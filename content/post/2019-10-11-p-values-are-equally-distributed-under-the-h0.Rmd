...
Finally, let's check the lower p-values to see if they are also equally distributed. Note that we reduce the sample size greatly by filtering on a small part of p-values so we should expect more variation around the expected value.
