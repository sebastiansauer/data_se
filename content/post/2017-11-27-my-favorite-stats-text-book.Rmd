...
1. is case study oriented ("Assume you would like to predict which movie will score highest next year based on some movie characterics you know")
...
7. is highly visually oriented, shows how to produce beautiful and effectice data visualizations

8. is technology savy, does not ignore the plethory of new technologies out there from JavaScript libraries, to RMarkdown, Shiny, Docker, Github, parallel computing, big queries, and more

9. is fully reproducibly, values open science
