...
Knime and R have their specific strengths (and weaknesses). Let's compare the R workflow in [this post](https://sebastiansauer.github.io/data_se/2020/12/05/execution-time-for-largish-data/#typical-data-wrangling) with this [knime workflow](https://github.com/sebastiansauer/sesa-blog/blob/main/static/div/largish-data-wrangling.knwf).
