...
den Tag im Jahr (Sommer 2025 vs. 2026 an derselben x-Position), dazu
je Jahr ein dezenter geglätteter Trend (gestrichelt, dünn, ohne
Konfidenzband).
...
Variante der Hitzewellen-Grafik von oben: statt Sommer 2025 vs. 2026
hier 2026 direkt gegen den geglätteten langjährigen Referenzwert
(1991-2020, siehe Methodik oben) – dieselben Tagesmaxima, nur mit dem
langfristigen Mittel statt dem Vorjahr als Vergleichslinie.

```{r klimatologie-vergleich-daten}
...
```{r klimatologie-vergleichsplot, fig.width = 8}
