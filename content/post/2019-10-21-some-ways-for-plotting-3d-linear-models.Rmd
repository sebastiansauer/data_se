...
In the `graphics` package of standard R, there's the `persp()` function, which will accept a linear model as input:



```{r}
graphics::persp(lm1, hp ~ disp, 
                zlab = "mpg",
...
For some reason, this code does not run in (my) rmarkdown setup, but it worked (on my machien) in a ordinary R script.
