...
A classical example for a normally distributed variable is height. However, I kept on looking for data as to the mean and sd for some populations, such as Germany. How I found some reliably looking data [here](https://tall.life/height-percentile-calculator-age-country/).
...
Simple, right? The z-value as indicated in the figure is the answer to the question: "Relative to the SD $sd$, how far are you ($X$) from the mean value $\mu$?". Mathy: $z = (X-\mu) / sd$. In this case: $z = (174 - 174) / 7 = 0$. This point falls right on the mean, zero distance from the mean, hence $z=0$. 
