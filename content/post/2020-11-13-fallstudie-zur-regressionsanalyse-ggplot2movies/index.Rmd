...
*Alternativ* kann man die Daten auch aus einer Datei einlesen:
...
Logarithmiert man die Zahl 0, so kommt `-Inf` heraus. Das ist keine Zahl und macht daher Problmee. Darum müssen wir uns noch kümmern.
...
Die Funktion fässt einen Vektor zu einem Skalar zusammen, kann also gut mit `summarise()` verwendet werden.
