...
And I retweeted some criticism on the "present era" tidyverse approach (see [this tweet](https://twitter.com/sauer_sebastian/status/1071511342220222465)). 
...
Then, Erich Neuwirth (`@neuwirthe`) informed me on Twitter, that there's a new idiom in `purrr()` (as of version 0.8.0) that might come as a remedy: `split_group()`. This post explore some of the uses of this idiom.
