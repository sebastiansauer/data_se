...
Note that the logistic regression (in R) models the *second* level of the outcome variable ([see here for more information](https://sebastiansauer.github.io/data_se/2022/02/11/die-logististische-regression-glm-modelliert-die-zweite-stufe/)).
