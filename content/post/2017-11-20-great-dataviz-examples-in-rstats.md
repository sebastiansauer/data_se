...
This work is from Zuguang Gu; see his package [circlize](https://www.rdocumentation.org/packages/circlize/versions/0.4.1). He is also the author from the corresponding free online [book](http://zuguang.de/circlize_book/book/).
...
See many more examples of nice diagrams at [The R Graph Gallery](https://www.r-graph-gallery.com/)
...
This example from Thomas Rahlf's book [Data Design with R](http://www.datendesign-r.de/) is nice:
